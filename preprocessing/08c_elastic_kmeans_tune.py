...
def train_boston(config):
    ...
    kmean = KMeans(n_clusters=config['n_clusters'], n_init=10, max_iter=1000,
...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        config={
            ...
            "n_clusters":tune.randint(3, 200)
        }

    )
    print("Best hyperparameters found were: ", analysis.best_config)
    # tensorboard --logdir /home/peterpirog/PycharmProjects/BostonEnsemble/ray_results/elastic_kmean --bind_all --load_fast=false
